...
def create_stylists()
    ...
    Stylist.create(first_name: "Susan", last_name: "Smith", years: 23, specialties: ["Long-Hair Services", "Formal Styling"], schedule: ["Monday", "Wednesday", "Saturday"], tag_line: "Lorem Ipsum Dorom.", profile_pic: "https://s3.amazonaws.com/HairEtcPittsburgh/images/stylists/stylist_example_img.png")
    Stylist.create(first_name: "Susan", last_name: "Smith", years: 23, specialties: ["Long-Hair Services", "Formal Styling"], schedule: ["Tuesday", "Thursday", "Saturday"], tag_line: "Lorem Ipsum Dorom.", profile_pic: "https://s3.amazonaws.com/HairEtcPittsburgh/images/stylists/stylist_example_img.png")
