...
def create_stylists()
    ...
    Stylist.create(first_name: "Tina", last_name: "Aubrey", years: 20, specialties: ["Foils", "HiLites"], schedule: ["By Appointment Only"], tag_line: "I don't want you to spend hundreds to like a million bucks!", profile_pic: "https://s3.amazonaws.com/HairEtcPittsburgh/images/stylists/Tina.png")
end
