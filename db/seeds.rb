...
def create_stylists()
    ...
    Stylist.create(first_name: "Susan", last_name: "Smith", years: 23, specialties: ["Updo", "Corrective Color"], schedule: ["Monday", "Thursday", "Friday"], tag_line: "Lorem Ipsum Dorom.", profile_pic: "https://s3.amazonaws.com/HairEtcPittsburgh/images/stylists/Chrissy.png")
